...
import { Mail, Lock, User, UserPlus, AlertTriangle, Sparkles } from 'lucide-react'
...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.detail || 'Registration failed. Use a different email or try again.')
    ...
    <div className="max-w-md mx-auto px-4 py-16 sm:py-24 min-h-screen flex flex-col justify-center relative">
      ...
      <div className="glass-panel p-8 sm:p-10 rounded-3xl relative z-10 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-500 text-sm">Join AuroraShop to initialize your recommendation vector matrix.</p>
        </div>
